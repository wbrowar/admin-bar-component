...
@layer admin-bar {
   admin-bar {
      ...
      --admin-bar-glass-bg: var(--admin-bar-bg, linear-gradient(var(--admin-bar-gradient-direction), color-mix(in srgb, var(--admin-bar-bg-color), transparent 10%), color-mix(in srgb, var(--admin-bar-bg-color), transparent 100%) 80%));
   ...
   @media (prefers-reduced-transparency) {
      admin-bar {
         ...
         --admin-bar-glass-bg: var(--admin-bar-bg, linear-gradient(var(--admin-bar-gradient-direction), var(--admin-bar-bg-color), color-mix(in srgb, var(--admin-bar-bg-color), transparent 50%) 80%));
         --admin-bar-button-popover-bg: var(--admin-bar-bg, color-mix(in srgb, var(--admin-bar-bg-color), transparent 20%));
      }
   }
}
```
